...
class Staff(models.Model):
	...
	working_address = models.CharField(max_length=100,blank=True,null=True, help_text="请输入工作地址.",)
	home_address = models.CharField(max_length=100,blank=True,null=True,help_text="请输入家庭地址.",)
	telephone_number = models.CharField(max_length=20,blank=True,null=True,help_text="请输入电话号码.",)
	id_number = models.CharField(max_length=20,blank=True,null=True,help_text="请输入身份证号.",)
	nationality = models.CharField(max_length=10,blank=True,null=True,help_text="请输入国籍.",)
	gender = models.CharField(max_length=1, choices=gender_category,blank=True,null=True,help_text="请输入性别.",)
	birth_date = models.DateTimeField(blank=True,null=True,help_text="请输入生日.",)
	Photo = models.ImageField(upload_to='Staff/',blank=True,null=True,help_text="请输入照片.",)
